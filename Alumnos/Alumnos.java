...
public class Alumnos extends JPanel {
    ...
    private void initComponents() {
        ...
        entityManager = java.beans.Beans.isDesignTime() ? null : javax.persistence.Persistence.createEntityManagerFactory("111mil?zeroDateTimeBehavior=convertToNullPU").createEntityManager();
        query = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT a FROM Alumnos_1 a");
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == saveButton) {
                Alumnos.this.saveButtonActionPerformed(evt);
            }
            else if (evt.getSource() == refreshButton) {
                Alumnos.this.refreshButtonActionPerformed(evt);
            }
            else if (evt.getSource() == newButton) {
                Alumnos.this.newButtonActionPerformed(evt);
            }
            else if (evt.getSource() == deleteButton) {
                Alumnos.this.deleteButtonActionPerformed(evt);
            }
        }
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<com.mil.colegio.Alumnos.Alumnos_1> toRemove = new ArrayList<com.mil.colegio.Alumnos.Alumnos_1>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            com.mil.colegio.Alumnos.Alumnos_1 a = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(a);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        com.mil.colegio.Alumnos.Alumnos_1 a = new com.mil.colegio.Alumnos.Alumnos_1();
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<com.mil.colegio.Alumnos.Alumnos_1> merged = new ArrayList<com.mil.colegio.Alumnos.Alumnos_1>(list.size());
            for (com.mil.colegio.Alumnos.Alumnos_1 a : list) {
    ...
    private java.util.List<com.mil.colegio.Alumnos.Alumnos_1> list;
...
//                frame.setContentPane(new Alumnos());
